...
// console.log(calc(4,2,multiply2)
...
// CODE HERE
uniq(names, uniqarr => console.log(`this is the new array after removing duplicates ${uniqarr}`))
...
// CODE HERE
each(names, dothis = (item, index) => console.log(`The item at index ${index} is ${item}`))
...
// CODE HERE
let addNumber = addingFactory(56)
